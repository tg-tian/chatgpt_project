...
VALUES
	...
	(17,'xfg-test02',1001,'OpenAi 测试商品(3.5)',100,NULL,'292932328126','2024-10-20 07:52:44',2,0.01,0,'因你未配置支付渠道，所以暂时不能生成有效的支付URL。请配置支付渠道后，在application-dev.yml中配置支付渠道信息',0.00,'1010191919',1,'2024-10-20 08:16:27','2024-10-20 15:52:44','2024-10-20 16:19:26'),
	(18,'xfg-test02',1001,'OpenAi 测试商品(3.5)',100,NULL,'418301185073','2024-10-20 08:45:48',2,0.01,0,'因你未配置支付渠道，所以暂时不能生成有效的支付URL。请配置支付渠道后，在application-dev.yml中配置支付渠道信息',10.00,'418301185073',1,'2024-10-20 08:46:19','2024-10-20 16:45:47','2024-10-20 16:48:10'),
	(19,'xfg-test02',1001,'OpenAi 测试商品(3.5)',100,NULL,'515019067766','2024-10-20 10:13:59',2,0.01,0,'因你未配置支付渠道，所以暂时不能生成有效的支付URL。请配置支付渠道后，在application-dev.yml中配置支付渠道信息',10.00,'515019067766',1,'2024-10-20 10:14:47','2024-10-20 18:13:59','2024-10-20 18:15:50');
...
VALUES
	(1,1001,'OpenAi 测试商品(3.5)','测试商品请勿下单','glm-4,gpt-4,gpt-3.5-turbo',100,0.01,1,1,'2024-10-20 10:55:59','2024-10-20 10:55:59'),
	(2,1002,'OpenAi 测试商品(3.5)','测试商品请勿下单','glm-4,gpt-4,gpt-3.5-turbo',200,0.02,2,1,'2024-10-20 10:55:58','2024-10-20 10:55:58'),
	(3,1003,'OpenAi 测试商品(3.5&4.0)','测试商品请勿下单','glm-4,gpt-4,gpt-3.5-turbo',50,10.00,3,1,'2024-10-20 10:55:57','2024-10-20 10:55:57'),
	(4,1004,'OpenAi 测试商品(3.5&4.0)','测试商品请勿下单','glm-4,gpt-4,gpt-3.5-turbo',100,18.88,3,0,'2024-10-20 10:55:56','2024-10-20 10:55:56');
...
VALUES
	(1,'xfg',112,108,'gpt-3.5-turbo,gpt-3.5-turbo-16k,chatGLM_6b_SSE,chatglm_lite,chatglm_lite_32k,chatglm_std,chatglm_pro,dall-e-2,dall-e-3',0,'2023-10-03 18:56:13','2024-10-20 10:08:22'),
	(2,'oxfA9w8-23yvwTmo2ombz0E4zJv4',8,5,'glm-4,gpt-4,gpt-3.5-turbo',0,'2024-10-19 09:41:58','2024-10-20 10:56:07'),
	(3,'xfg-test02',300,300,'glm-4,gpt-4,gpt-3.5-turbo',0,'2024-10-20 16:16:54','2024-10-20 18:15:50');
